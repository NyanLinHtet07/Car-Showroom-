...
<div class='feturedimage'>
	...
	<h1 class="text-center" style="font-weight:'bolder'; color:#a03b3b; text-shadow:3px 3px 3px grey; ">RECENT CARS </h1>
	</div>
</div>
...
<?php
					 ...
					 include("connection.php");
						...
						$sel=mysql_query("select * from cars ORDER BY RAND() LIMIT 4");
...
<!-- ________________________Latest Cars Image Thumbnail________________-->
    ...
    while($arr=mysql_fetch_array($sel))
   {
	$i=$arr['img'];
					...
					echo"
					<div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'><div class='txthover'>
						<img src='admin/image/$i' height='300' width='300'>
					...
					<div class='txtcontent'>
							...
							<div class='simpletxt'>
                                <h3 class='name'>Company name:</h3>".$arr['company'] .
                                "<h3 class='name'>Car Series:</h3>".$arr['series'].
                                 "<h3 class='price'> Price</h3>".$arr['price'].
                                 "<br><a href='login.php?img=$i' class='bas'><i class='fa fa-shopping-basket'></i><b>Order</b></a><br>
