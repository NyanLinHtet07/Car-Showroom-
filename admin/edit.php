...
$sql=mysql_query("select * from popularcar where series='{$_GET['series']}'");
$row=mysql_fetch_array($sql);

extract($_POST); 
if($upd)
{
mysql_query("update popularcar set  company='$company',price='$price' where series='{$_GET['series']}'");
header('location:viewpopular.php');
}
