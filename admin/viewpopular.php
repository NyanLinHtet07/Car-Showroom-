                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="header" style="text-align: center; text-shadow:2px 2px 2px gold; background-color:white;">
                            <h1><strong>View</strong> Popular Car List </h1>
                        ...
                        <div class="table-responsive social_media_table">
                            <table class="table table-hover c_table">
                                ...
                                <?php
                                   ...
                                   {
                                    $i=$row['img'];
                                       $car ="<img src='images/$i'  style='max-width:200px;' 'max-height:200px;'>";
                                       $com = $row['company'];
                                       $ser = $row['series'];
                                       $pri =$row['price'];
                                       ...
                                       <tbody>
                                           ...
                                           <th><?php echo $ser;?></th>
                                           <th><?php echo $pri;?></th>
                                           <th><a href='edit.php?series=<?php  echo "$ser"; ?>'><i class="zmdi zmdi-edit"></i></a></th>
                                           <th><a href='deletep.php?img=<?php echo "$i";?> & series=<?php  echo "$ser"; ?>'><i class="zmdi zmdi-delete"></i>
                                           </a></th>
                                           </tr>
                                       </tbody>
                                   <?php }?>
